...
const LANG = {
  pt: {
    ...
    gameSettings: 'Configuracões do Jogo',
    rounds: 'Rodadas',
    ...
    catCinematica: 'Cinemática e Mecânica',
    catEnergia: 'Energia e Trabalho',
    catTermodinamica: 'Termodinâmica',
    catOndas: 'Ondas e Som',
    catOptica: 'Ótica',
    catEletricidade: 'Eletricidade e Magnetismo',
    catModerna: 'Física Moderna',
    catAstronomia: "Astronomia",
    ...
    streakBonus: 'Sequência x{mult}',
    doubleBonus: 'Pontos Duplos: x2',
    streak: 'sequência',
    diffEasyLabel: 'Fácil',
    diffMediumLabel: 'Média',
    diffHardLabel: 'Difícil',
    powerupsAvailable: 'Power-ups disponíveis:',
    teamWinsCorrect: '{team} acertou e venceu!',
    teamWinsWrong: '{team} errou! {other} vence!',
    noOneBuzzed: 'Ninguém respondeu! Nova pergunta...',
  },
  en: {
    gameTitle: 'Physics Quiz',
...
const Game = {
  ...
  timerInterval: null,
  difficulty: 'all',
  categories: ['cinematica', 'energia', 'termodinamica', 'ondas', 'optica', 'eletricidade', 'moderna', 'astronomia'],
  questionPool: [],
...
function startGame() {
  ...
  if (Game.categories.length === 0) {
    Game.categories = ['cinematica', 'energia', 'termodinamica', 'ondas', 'optica', 'eletricidade', 'moderna', 'astronomia'];
  }
